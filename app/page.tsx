...
const features = [
  {
    ...
    title: "Smart Booking",
    desc: "Clients book directly from your website. Deposits, contracts, and confirmations handled automatically.",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    desc: "Know exactly what you have. Track balloons, supplies, and equipment across every job.",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    desc: "Generate professional quotes in seconds. Clients get beautiful PDFs — you get paid faster.",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    title: "Client CRM",
    desc: "Every client, job, and conversation in one place. Never lose a lead or forget a detail again.",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    desc: "See which jobs, months, and clients are most profitable. Make decisions with real data.",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    desc: "Reminders, thank-you notes, and review requests sent automatically at the right time.",
  },
];

const testimonials = [
  {
    quote: "I was running everything in WhatsApp and a spreadsheet. BalloonBase changed how I run my business completely.",
    name: "Sarah Mitchell",
    role: "Balloon artist, London",
    initials: "SM",
  },
  {
    quote: "My bookings doubled in 3 months. Clients love the professional quotes and my admin time dropped by half.",
    name: "Jade Williams",
    role: "Party decorator, Manchester",
    initials: "JW",
  },
  {
    quote: "The inventory tracking alone is worth it. I used to over-order constantly — now I know exactly what I need.",
    name: "Priya Patel",
    ...
    <>
      ...
      <section className="hero">
        <div className="hero-badge">
          ...
          Built for balloon decoration businesses
        </div>
        <h1>
        ...
        <p className="hero-sub">
          Bookings, inventory, quotes, and client management — all in one clean workspace built for balloon decorators.
        </p>
        <div className="hero-ctas">
          ...
          <Link href="/login" className="btn btn-outline btn-lg">See a demo</Link>
        </div>
        ...
        <div className="section-inner">
          <div ref={featuresRef.ref} className="section-header">
            ...
            <p className={`section-sub reveal reveal-delay-1 ${featuresRef.inView ? "in" : ""}`}>
              Purpose-built tools for balloon businesses — not a generic CRM with your logo on it.
            </p>
          </div>
      ...
      <section className="section" id="how">
        <div className="section-inner">
          <div ref={howRef.ref} className="section-header">
            ...
            <h2 className={`section-title reveal ${howRef.inView ? "in" : ""}`}>Up and running in minutes.</h2>
            <p className={`section-sub reveal reveal-delay-1 ${howRef.inView ? "in" : ""}`}>
              No training, no onboarding calls. Just sign up and start taking bookings.
            </p>
          </div>
          <div className="steps">
            {[
              {
                ...
                desc: "Sign up in under a minute. Add your business details, services, and pricing. We handle the setup.",
              },
              {
                n: "Step 02",
                title: "Share your booking link",
                desc: "Drop your link in your Instagram bio or website. Clients book, pay deposits, and sign contracts — automatically.",
              },
              {
                n: "Step 03",
                title: "Manage everything in one place",
                desc: "Jobs, clients, stock, and revenue — all in your dashboard. No more juggling apps, spreadsheets, or DMs.",
              },
            ].map((s, i) => (
              <div
                key={s.n}
      ...
      <section className="section pricing-bg" id="pricing">
        <div className="section-inner">
          <div ref={pricingRef.ref} className="section-header">
            ...
            <h2 className={`section-title reveal ${pricingRef.inView ? "in" : ""}`}>Simple, honest pricing.</h2>
          ...
          <div className={`pricing-grid reveal reveal-delay-3 ${pricingRef.inView ? "in" : ""}`}>
            ...
            <div className="pricing-card">
              <div className="pricing-plan">Tier 1</div>
              ...
              <ul className="pricing-features">
                {["Quick Quote and Detailed Quote", "Catalog, Inventory, Packages, and Add-ons", "Quote PDF and copy text tools", "Global quote settings", "Email support"].map(item => (
                  <li key={item}>
            ...
            <div className="pricing-card featured">
              ...
              <ul className="pricing-features">
                {[
                  ...
                  "AI Length Estimator - Pro",
                  "AI Mockup Generator access - Pro",
              ...
              <Link href={PRO_PLAN_PUBLICLY_AVAILABLE ? "/signup?plan=pro" : "/waitlist?plan=pro"} className="btn btn-primary" style={{ width: "100%", justifyContent: "center" }}>
                {PRO_PLAN_PUBLICLY_AVAILABLE ? "Start free trial" : "Join Pro waitlist"}
              </Link>
            </div>
            ...
            <div className="pricing-card">
              ...
              <Link href="/waitlist?plan=studio" className="btn btn-outline" style={{ width: "100%", justifyContent: "center" }}>
